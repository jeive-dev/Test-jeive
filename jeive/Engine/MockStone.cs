...
namespace jeive.Engine
{
    public class StoneApi
    {
        /*
              ...
              { // not need implement or need? maybe, dont now :D

              }

              public class BoletoTransactionResultCollection : List<BoletoTransactionResult>
              { 
        ...
        {
            public CreditCardTransactionCollection(IEnumerable<CreditCardTransaction> collection)
                : base(collection)
            {
